...
| (5) | BR 2 | Xác thực dữ liệu bắt buộc:<br>- Danh mục (Level 1): Phải nhập Tên.<br>- Dòng sản phẩm (Level 2): Phải chọn Thuộc Danh mục (Level 1) và nhập Tên.<br>- Sản phẩm (Level 3): Phải chọn Thuộc Dòng sản phẩm (Level 2) và nhập Tên.<br><br>**Quy tắc chống trùng lặp (Duplicate Check):**<br>- **Level 1:** Tên danh mục không được trùng với các Danh mục (Level 1) khác trên hệ thống.<br>- **Level 2:** Tên dòng sản phẩm không được trùng với các Dòng sản phẩm (Level 2) khác nằm trong **cùng một Danh mục cha**.<br>- **Level 3:** Tên sản phẩm/dịch vụ không được trùng với các Sản phẩm (Level 3) khác nằm trong **cùng một Dòng sản phẩm cha**. |
