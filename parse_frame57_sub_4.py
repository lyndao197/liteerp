...
with open('frame57_subcomponents_leaf.tsx', 'w', encoding='utf-8') as out_f:
    for name in ['Search', 'Input2', 'Frame63', 'Frame62', 'KabanList', 'Frame8', 'Frame13', 'Container55', 'Container56']:
        out_f.write(f"// =================== {name} ===================\n")
        out_f.write(extract_fn(name) + "\n\n")

print("Done writing frame57_subcomponents_leaf.tsx")
