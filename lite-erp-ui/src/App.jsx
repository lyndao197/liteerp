...
function AppContent() {
  ...
  const isContractPage = location.pathname.includes('/contract/new') || location.pathname.includes('/contract/edit');
  ...
  return (
    <div className="layout">
      ...
      <div className="main-wrapper">
        <Header />
        <main className={`main-content ${isContractPage ? 'no-padding' : ''}`}>
          <Routes>
